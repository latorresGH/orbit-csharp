...
/// <summary>
/// Levanta la Api in-memory para los tests de integración de proveedores, apuntando a una base dedicada
/// <c>orbit_csharp_proveedortest</c>. Mismo patrón que las demás factories: la config se inyecta por
/// variables de entorno (Program.cs arma el NpgsqlDataSource antes de builder.Build()) y la colección
/// corre con <c>DisableParallelization</c> para no pisar esas env vars globales con otros factories.
/// </summary>
public sealed class ProveedorWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_proveedortest;Username=postgres;Password=lauri2001";
...
public sealed class ProveedorApiCollection
{
    public const string Name = "Proveedores Api collection";
}
