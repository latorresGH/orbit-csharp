...
/// <summary>
/// Levanta la Api in-memory para los tests de integración de códigos de descuento, base dedicada
/// <c>orbit_csharp_codigotest</c>. Mismo patrón que las demás factories.
/// </summary>
public sealed class CodigoDescuentoWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_codigotest;Username=postgres;Password=lauri2001";
    ...
    public CodigoDescuentoWebAppFactory()
    {
...
public sealed class CodigoDescuentoApiCollection
{
    public const string Name = "CodigosDescuento Api collection";
}
