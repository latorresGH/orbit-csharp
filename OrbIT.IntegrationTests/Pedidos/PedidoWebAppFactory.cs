...
/// <summary>
/// Levanta la Api in-memory para los tests de integración de pedidos, base dedicada
/// <c>orbit_csharp_pedidotest</c>. Mismo patrón que las demás factories.
/// </summary>
public sealed class PedidoWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_pedidotest;Username=postgres;Password=lauri2001";
...
public sealed class PedidoApiCollection
{
    public const string Name = "Pedidos Api collection";
}
