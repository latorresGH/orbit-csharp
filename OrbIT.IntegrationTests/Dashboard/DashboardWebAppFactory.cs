...
/// <summary>
/// Levanta la Api in-memory para los tests de integración del dashboard, base dedicada
/// <c>orbit_csharp_dashboardtest</c>. Mismo patrón que las demás factories.
/// </summary>
public sealed class DashboardWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_dashboardtest;Username=postgres;Password=lauri2001";
...
public sealed class DashboardApiCollection
{
    public const string Name = "Dashboard Api collection";
}
