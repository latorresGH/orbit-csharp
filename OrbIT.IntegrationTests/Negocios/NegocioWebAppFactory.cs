...
/// <summary>
/// Levanta la Api in-memory para los tests de integración de negocio, base dedicada
/// <c>orbit_csharp_negociotest</c>. Mismo patrón que las demás factories.
/// </summary>
public sealed class NegocioWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_negociotest;Username=postgres;Password=lauri2001";
...
public sealed class NegocioApiCollection
{
    public const string Name = "Negocio Api collection";
}
