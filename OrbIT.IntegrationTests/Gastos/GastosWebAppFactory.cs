...
/// <summary>
/// Levanta la Api in-memory para los tests de integración de gastos, base dedicada
/// <c>orbit_csharp_gastostest</c>. Mismo patrón que las demás factories.
/// </summary>
public sealed class GastosWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_gastostest;Username=postgres;Password=lauri2001";
...
public sealed class GastosApiCollection
{
    public const string Name = "Gastos Api collection";
}
