...
/// <summary>
/// Levanta la Api in-memory para los tests de integración de clientes, apuntando a una base dedicada
/// <c>orbit_csharp_clientetest</c>. Mismo patrón que las demás factories: la config se inyecta por
...
/// </summary>
public sealed class ClienteWebAppFactory : WebApplicationFactory<Program>
{
    public const string ConnectionString =
        "Host=localhost;Port=5432;Database=orbit_csharp_clientetest;Username=postgres;Password=lauri2001";
...
public sealed class ClienteApiCollection
{
    public const string Name = "Clientes Api collection";
}
